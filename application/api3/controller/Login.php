...
use app\api3\model\ImgDownModel;
use app\api3\service\LoginService;
use app\api3\service\RongCloudService;
use app\api3\service\LogsService;
/**
 * Class Login
...
class Login extends ApiBase {
    ...
    public function index(){
        ...
        $remark = serialize(['mobile'=>$mobile, 'verify'=>$verify]);
        if(is_int($result)){
            LogsService::self()->add(0, 0, OTHER_ACT, 0, LOGIN, ERR_ACT, $remark);
            $this->wrong(0, '登录失败');
        }
        LogsService::self()->add(0, 0, OTHER_ACT, 0, LOGIN, SUC_ACT, $remark);
