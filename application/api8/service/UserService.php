...
use think\Cache;
use think\Config;
use app\api8\model\UserModel;
use app\api8\model\UserExtModel;
use app\api8\model\UserAccountModel;
use app\api8\model\ConfigModel;
use app\api8\model\RunningModel;
use app\api8\model\LogsModel;
use app\api8\service\RongCloudService;
use app\api8\service\OrderAccountService;
    ...
    public function running($uid = '', $page = 1, $limit = 10){
        ...
        if($lists){
            foreach ($lists as $val) {
                ...
                $val['money_flag'] = running_flag($val['type']);
                $tmp_lists[] = $val;
            }
        }
        return $tmp_lists;
