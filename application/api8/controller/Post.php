...
use app\api8\model\FeedbackModel;
use app\common\model\ReportsModel;
use app\api8\model\BlackListModel;
...
class Post extends ApiLogin {
    ...
    private $dmessage  =   [
        ...
        'intro.require'   => '请输入邀约备注',
        // 'attaches.require'   => '请上传至少一张图片',
    ];
    protected $scene = [
        'service'  =>  ['title','price','price_unit', 'skills','is_online', 'intro','category_id','time_id', 'city_id'],
        'demand'  =>  ['category_id','title','time_type', 'province_id', 'city_id', 'area_id', 'gender', 'pay_way', 'intro'],
    ];
    ...
    public function comment(){
        ...
        $res = CommentsService::add($order_id, $source_id, $content, $star, $is_anonymous, $type, $this->user);
