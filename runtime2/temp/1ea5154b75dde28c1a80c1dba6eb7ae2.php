<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\phpStudy\WWW\think\public/../application/admin\view\login\index.html";i:1508135916;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!--            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img id="verify_img" src="<?php echo captcha_src(); ?>" alt="验证码" onclick="login.refreshVerify()">
                </div>
            </div> -->
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
